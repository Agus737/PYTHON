...
# Función evaluar calcula el valor total de los objetos seleccionados y compara si el peso total de estos no supera el peso total máximo(evalución)
...
# uso con items definidos y peso definido(inincialisación de items y peso de mochila)
